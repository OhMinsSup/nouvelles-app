...
export default function WriteForm({ isDialog }: WriteFormProps) {
...
WriteForm.Submit = function Item({ isDialog, isPending }: SubmitProps) {
...
WriteForm.EditorMessage = function Item({
  errors,
  id,
  remoteError,
}: EditorMessageProps) {
